...
export const sampleCourses: Course[] = [
  {
    ...
    description: 'Domina los principios fundamentales del liderazgo efectivo en el entorno laboral actual. Aprende a inspirar equipos, tomar decisiones estratégicas y impulsar el éxito organizacional. Docente: Nour Ariza',
  ...
  },
  {
    ...
    description: 'Obtén conocimientos fundamentales en principios de ciberseguridad, amenazas y mejores prácticas para proteger los datos y sistemas organizacionales de ataques maliciosos. Docente: Alexandre Blanco',
  ...
  },
  {
    ...
    description: 'Aprende metodologías esenciales de gestión de proyectos, herramientas y técnicas para planificar, ejecutar y completar proyectos a tiempo y dentro del presupuesto. Docente: Mercedes Bernal',
  ...
  },
  {
    ...
    description: 'Desarrolla las habilidades para ofrecer experiencias excepcionales al cliente que construyan lealtad y apoyen el crecimiento del negocio a través de comunicación efectiva y resolución de problemas. Docente: Paulino Amoros',
  ...
  },
  {
    ...
    description: 'Aprende a recolectar, analizar e interpretar datos para impulsar decisiones comerciales informadas e identificar oportunidades de crecimiento y mejora organizacional. Docente: Noe Bermejo',
  ...
  },
  {
    ...
    description: 'Desarrolla estrategias para crear un lugar de trabajo inclusivo que valore la diversidad, promueva la equidad y fomente un sentido de pertenencia para todos los empleados. Docente: Salma Berenguer',
